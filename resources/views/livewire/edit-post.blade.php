<div>
    <a wire:click='$set("open", true)' class="cursor-pointer bg-blue-600 p-2 rounded hover:bg-blue-400"><i class="fa fa-pencil-square-o text-white"></i></a>
        ...
        <x-slot name="content">
            <div wire:loading wire:target='image' class="w-full my-4 bg-indigo-100 border-t-4 border-indigo-500 rounded-b text-indigo-900 px-4 py-3 shadow-md" role="alert">
              ...
              @if ($image)
                ...
                @endif
            <div class="mb-4">
                <x-jet-label value="Titulo del post" class="text-left"/>
                <x-jet-input type="text" class="w-full" wire:model='post.name'/>
            </div>
            <div class="mb-4">
                <x-jet-label value="Contenido del post"/>
                <x-jet-input type="text" class="w-full" wire:model='post.course_id'/>
            </div>
            <div class="mb-4">
